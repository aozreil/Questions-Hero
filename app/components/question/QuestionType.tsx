...
export default function QuestionType({ answerCount, hasAiAnswer, hasVerifiedAnswer }: Props) {
  return (
    ...
    ? hasAiAnswer && !hasVerifiedAnswer
        ? <div data-cy="question-type" className="flex items-center space-x-2 text-[#ff9700] font-bold">
            <img src="/assets/images/ai-answered.svg" alt="verifed" />
            <p>Verified by Askgram AI</p>
          </div>
        : hasVerifiedAnswer
          ? <div data-cy="question-type" className="flex items-center space-x-2 text-[#25b680] font-bold">
