          ...
          !!answers?.length
            ? (
              <>
                ...
                {!!slug && (
                  <>
                    <Link to={`/question/${slug}`} className="max-lg:hidden p-4 pt-0 text-sm mt-4 hover:text-[#070707] text-gray-500 text-center">
                      Go to question page for more information
                    </Link>
                    <Link to={`/question/${slug}`} className="lg:hidden outline-none block text-white py-3 bg-[#070707] w-[90%] my-4 max-sm:-mt-3 mx-auto rounded-2xl text-center">
                      Go to Question Page
                    </Link>
                  </>
                )}
