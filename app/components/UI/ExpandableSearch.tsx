...
export default function ExpandableSearch() {
    ...
    return (
        ...
        >
            ...
            <textarea
              className='textarea-scrollable max-sm:mt-0.5 border-0 rounded-lg cursor-text resize-none w-full text-left py-0.5 flex-1 mx-3 max-h-[158px] bg-white outline-none text-xl'
              rows={1}
              name='term'
