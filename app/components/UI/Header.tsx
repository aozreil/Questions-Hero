...
export default function Header() {
  ...
  return (
    <header className={`sticky  top-0 z-40 w-full bg-[#f7f8fa] border-t-[3px] border-t-[#070707] pt-7 pb-6`}>
      <div className={`container flex items-center justify-between ${location?.pathname?.includes("question") ? "bg-white  border-b-[3px] border-[#ebf2f6]" : ""} `}>
