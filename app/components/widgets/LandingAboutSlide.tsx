          ...
          {HOW_SECTIONS.map((section) => (
            ...
            >
              <div className="relative flex justify-center group peer items-end w-[95%] xs:w-96 h-40 border-b-[3px] border-[#d8d8d8] mb-6">
                <div className="absolute w-[80%] xs:w-72 h-32 2xl:h-36 bg-[#f3f4f4] rounded-t-full transition" />
                <img
                  src={section.imgSrc}
                  alt="they-how"
                  className="absolute h-32 2xl:h-36 group-hover:h-40 flex-shrink-0 bottom-0 transition"
                />
              </div>
