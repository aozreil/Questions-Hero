export const BASE_URL = "https://questions-herodev.work";
export const GOOGLE_ANALYTICS_KEY = "G-SMNPKG0RR4";
export const SITE_BASE = "https://questions-hero.work";
export const GOOGLE_SIGN_IN_CLIENT_ID =
  "761946262599-ru0jcosed1hrfcjca25g6fmt7v75dfnr.apps.googleusercontent.com";
export const RECAPTCHA_PUBLIC_KEY = "6LeX-aopAAAAAPy0X1xw3m4hdT0TDvSLyX4aT7xM";
export const ATTACHMENTS_BASE = "https://attachments.questions-herodev.work";
...
export const PRODUCT_LOGO_IMAGE = "https://questions-herodev.work/assets/images/logo.png";
