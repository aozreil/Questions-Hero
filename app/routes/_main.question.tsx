...
export default function QuestionPage() {
    return (
        <div className='w-screen h-screen overflow-x-hidden'>
            <Header />
            <div className='w-full h-fit flex flex-col items-center border-t-[3px] border-[#f7f8fa] py-4 px-4'>
                <div className='max-lg:max-w-[540px] flex-shrink lg:w-fit'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center gap-4'>
                        <div className='max-w-[540px] lg:w-[540px] flex flex-col'>
                            <div className='flex flex-col items-center w-full border border-[#00000038] rounded-lg p-4'>
                                <div className='w-full flex flex-wrap justify-between items-center mb-3'>
                                    ...
                                    <div className='flex items-center gap-[6px] text-[#25b680] text-[15px] font-bold'>
                                        <img src='/assets/images/verified.png' alt='verifed' />
                                        <p>Verified Answer</p>
                                    </div>
                                </div>
                                ...
                                <div className='w-full flex flex-col'>
                                    <div className='w-full flex justify-between items-center'>
                                        ...
                                        <img src='/assets/images/drop-down.png' alt='arrow-down' className='h-[14px]' />
                                    </div>
                                    <div className='text-[13px] mt-4'>
                                        <p className='mb-1 font-bold'>Nurse overhears</p>
                                    ...
                                    <div className='text-[13px] mt-4'>
                                        <p className='mb-1 font-bold'>Really psycho</p>
                                    ...
                                    <div className='text-[13px] mt-4'>
                                        <p className='mb-1 font-bold'>Receptionist</p>
                        ...
                        <div className='w-full lg:w-[317px]'>
                            <div className='w-full bg-[#eaf1fa] text-sm font-medium text-[#344f60] p-3 border border-[#e0e0e0] rounded-lg flex flex-col items-center'>
                                <img src='/assets/images/objectives.png' alt='objectives' className='w-[71px] mb-[26px]' />
                            ...
                            <div className='w-full mt-4 p-3 pt-[20px] border border-[#e0e0e0] rounded-lg flex flex-col'>
                                ...
                                <div className='flex flex-col [&>*:last-child]:border-0'>
                                    {RELATED.map(related => (
                                        <div className='flex justify-between items-center text-[#4d6473] text-sm py-3 border-b border-[#e0e0e0]'>
                                            <p className='truncate'>{related}</p>
                                            <img src='/assets/images/related-arrow.png' alt='arrow' className='h-4 flex-shrink-0' />
                                        </div>
                                    ))}
                                </div>
                            </div>
