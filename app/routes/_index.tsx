  ...
  return (
    <div className='w-screen h-screen bg-[#fbfbfc]'>
        ...
        <section className='px-4 flex flex-col items-center my-[70px] md:my-[126px] text-[#070707]'>
            ...
            <div className='grid xl:grid-cols-3 mt-[88px] gap-[50px] items-center justify-center'>
                {HOW_SECTIONS.map((section) => (
                    <div key={section.title} className='flex flex-col items-center'>
                        <img src={section.imgSrc} alt='they-how' className='w-[380px] mb-6 flex-shrink-0' />
        ...
        <footer className='w-full gap-2 sm:gap-0 text-xs sm:text-[15px] border-t-[2px] border-[#ebf2f6] px-4 md:px-[55px] py-[27px] text-[#6e777f] flex justify-center sm:justify-between items-center flex-wrap'>
