...
const Data: ITerms = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "terms": [
        "3.1. <b>Copyright:</b> All content on the Service, including text, graphics, logos, button icons, images, audio clips, digital downloads, and data compilations, is the property of Askgram or its content suppliers and is protected by copyright laws.",
        "3.2. <b>Trademarks:</b> The trademarks, service marks, and logos used and displayed on the Service are registered and unregistered trademarks of Askgram and others. Nothing in these terms of use grants you any license or right to use any trademarks displayed on the Service without the express written permission of the trademark owner."
      ]
    },
    {
      "title": "Limitation of Liability",
      "terms": [
        "4.1. <b>Disclaimer:</b> The Service is provided on an \"as is\" and \"as available\" basis without any warranties of any kind, either express or implied. Askgram makes no representations or warranties about the accuracy or completeness of any content on the Service or the availability of the Service.",
        "4.2. <b>Limitation of Liability:</b> To the fullest extent permitted by applicable law, Askgram shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising out of or in connection with your use of the Service, including but not limited to any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of any content posted, emailed, transmitted, or otherwise made available via the Service, even if advised of their possibility."
      ]
    },
    {
      "title": "Indemnification",
      "terms": [
        "You agree to indemnify and hold harmless Askgram and its affiliates, officers, directors, employees, and agents from and against any and all claims, liabilities, damages, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising out of or in connection with your use of the Service or your violation of these terms of use."
      ]
    },
    {
