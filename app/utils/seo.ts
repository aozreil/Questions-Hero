...
export const DEFAULT_META_DESCRIPTION = `${PRODUCT_NAME} platform offers a collaborative space where students, educators, and enthusiasts can connect, ask questions, and discover answers in a supportive community.`;
